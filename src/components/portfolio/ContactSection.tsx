...
const socialLinks = [
  {
    name: "Email",
    icon: Mail,
    href: "mailto:sounak.patra@example.com",
    label: "sounak.patra@example.com",
  },
  {
    name: "GitHub",
    icon: Github,
                ...
                <div className="space-y-4">
                  {socialLinks.map((link) => (
                    <a
                      ...
                      className="flex items-center gap-4 p-4 rounded-xl bg-card hover:shadow-primary transition-all duration-300 group"
                    >
